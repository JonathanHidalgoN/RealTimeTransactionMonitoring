...
public class SecurityHeadersTests
{
    ...
    private string GenerateTestUserToken()
    {
        ...
        return jwtService.GenerateAccessToken(testUser);
    }
    ...
    public async Task SecurityHeaders_ShouldBePresent_OnApiResponses()
    {
        ...
        var response = await client.GetAsync(AppConstants.Routes.GetTransactionsPath("2.0"));
    ...
    {
        // Deliberately not adding JWT token to trigger 401
        var client = _factory.CreateClient();
